...
select  first.department_id, firsthired - Lasthired as [Difference brtween fisrt and last salary] from
(select department_id,  salary as firsthired from Employees
...
select *, DATENAME(WEEKDAY,Hire_Date) from HR_Staff


alter function Number_of_daysWorked ()
returns table
as
